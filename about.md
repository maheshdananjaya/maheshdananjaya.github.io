...
<p align="justify"><strong> I am broadly interested in computer architecture and compiler support for parallel computing, memory systems and big data systems with a particular emphasis on <b>memory consistency</b>, <b>memory persistency</b> and <b>cache coherency</b>. This is motivated by the current trends in high performance and energy-efficient systems design for compute-intensive and data-intensive applications with emerging workloads.</strong></p> 
